...
/**
 * @constant
 * @desc Map of standard nut/bolt sizes to dimensions [width, thickness, diameter].
 * Keys are size names (e.g. "M3", "#4"), values are [width_across_flats, nut_thickness, screw_diameter].
 */
const HexSizes = {
    "M1.6": [3.2, 1.3, 1.6],
    "M2": [4, 1.6, 2],
...
/**
 * Class for drawing nut holes.
 */
class NutHole {
    /**
     * Create a NutHole instance.
     * @param {Boxes} boxes - The boxes instance to draw on.
     */
    constructor(boxes) {
        this.boxes = boxes;
    }
    ...
    /**
     * Draw a nut hole.
     * @param {string|number} size - The size key (e.g. "M3") or numeric width.
