...
import { HingeSettings  } from '../edges.js';
...
class Kamishibai extends _TopEdge {
    ...
    coverPanel3Side(wi, hi, lockStyle, move, label) {
        ...
        this.polyline(0, 90, (((hi + (this.thickness * 2)) - this.Margin) / 2), 90, (((wi + (this.thickness * 2)) - this.Margin) / 4), ((-Math.tan(((2 * ((hi + (this.thickness * 2)) - this.Margin)) / ((wi + (this.thickness * 2)) - this.Margin))) * 180) / Math.PI), Math.sqrt((Math.pow((((hi + (this.thickness * 2)) - this.Margin) / 4), 2) + Math.pow((((wi + (this.thickness * 2)) - this.Margin) / 8), 2))), ((Math.tan(((2 * ((hi + (this.thickness * 2)) - this.Margin)) / ((wi + (this.thickness * 2)) - this.Margin))) * 180) / Math.PI), (((wi + (this.thickness * 2)) - this.Margin) / 8), 90, ((((hi + (this.thickness * 2)) - this.Margin) * 3) / 4), 90);
    ...
    coverPanel3Top(wi, hi, lockStyle, move, label) {
        ...
        this.polyline((wi + (this.thickness * 2)), 90, (((hi + (this.thickness * 2)) - this.Margin) / 4), 90, (((wi + (this.thickness * 2)) / 8) + (this.Margin / 2)), ((-Math.tan(((2 * ((hi + (this.thickness * 2)) - this.Margin)) / (wi + (this.thickness * 2)))) * 180) / Math.PI), Math.sqrt((Math.pow((((hi + (this.thickness * 2)) - this.Margin) / 4), 2) + Math.pow(((wi + (this.thickness * 2)) / 8), 2))), ((Math.tan(((2 * ((hi + (this.thickness * 2)) - this.Margin)) / (wi + (this.thickness * 2)))) * 180) / Math.PI), (((wi + (this.thickness * 2)) / 2) - !this.Margin), ((Math.tan(((2 * ((hi + (this.thickness * 2)) - this.Margin)) / (wi + (this.thickness * 2)))) * 180) / Math.PI), Math.sqrt((Math.pow((((hi + (this.thickness * 2)) - this.Margin) / 4), 2) + Math.pow(((wi + (this.thickness * 2)) / 8), 2))), ((-Math.tan(((2 * ((hi + (this.thickness * 2)) - this.Margin)) / (wi + (this.thickness * 2)))) * 180) / Math.PI), (((wi + (this.thickness * 2)) / 8) + (this.Margin / 2)), 90, (((hi + (this.thickness * 2)) - this.Margin) / 4), 90);
