...
class OptionsShowcase extends Boxes {
    ...
    drawWalls(startX, startY) {
        ...
        // Rectangular wall
        this.drawLabel("rectangularWall", startX, y);
        this.ctx.save();
        this.moveTo(startX, y + 8);
        ...
        // Trapezoid wall
        this.drawLabel("trapezoidWall", startX, y);
        this.ctx.save();
        this.moveTo(startX, y + 8);
        ...
        // Rounded plate
        this.drawLabel("roundedPlate", startX, y);
        this.ctx.save();
        this.moveTo(startX, y + 8);
    ...
    render() {
        ...
        // Footer with info (moved to bottom)
        this.text("Generated by boxes.js | thickness: " + this.thickness + "mm | burn: " + this.burn + "mm", 100, 475, 0, "", 3);
    }
}
